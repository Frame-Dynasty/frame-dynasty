              ...
              <section>
                ...
                <form onSubmit={handleSave} className="space-y-4">
                  ...
                  <div>
                    ...
                    >
                      <input ref={fileInputRef} type="file" accept="image/*,image/webp,image/avif" className="hidden"
                  ...
                  <div>
                    ...
                    {supplementImages.length < 10 && (
                      ...
                      >
                        <input ref={supplementInputRef} type="file" accept="image/*,image/webp,image/avif" multiple className="hidden"
