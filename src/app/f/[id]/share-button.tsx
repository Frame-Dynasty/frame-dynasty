    ...
    <div className="flex items-center gap-2">
      {platforms.map((p) => (
        <a
          ...
          className={`p-2.5 rounded-lg border border-white/10 text-white/50 transition-all duration-150 active:scale-[0.96] ${p.bg}`}
      ...
      <button
        ...
        className="inline-flex items-center gap-2 px-4 py-2.5 rounded-lg border border-gold/30 text-gold hover:border-gold/60 hover:bg-gold/5 transition-all duration-150 text-sm font-[family-name:var(--font-montserrat)] font-medium active:scale-[0.96]"
      >
